...
/// Object to lock a constraint to the height of the keyboard
///
/// Designed to be created programatically or inside a nib
/// You must set both the `view` and `constraint` properties
